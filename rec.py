...
rating_choices = [
    (1.,'Reasonable','Good reasoning was demonstrated'),
    (1.,'Strong','Support was given that would be difficult to attack'),
    (1.,'Eloquent','Elegantly weaves clarity with respectful articulation'),
    (1.,'Interesting','A clever or novel point was made'),
    (-1.,'Impolite','Ad hominem, undignified, rude, petulent, or flippant'),
    (-1.,'Straw-man','Battles a misrepresentation of an opponent\'s position'),
    (-1.,'Preaching','An opinion or forecast was expressed without justification or supporting reasons'),
    (-1.,'Anecdotal','Attempts to establish a trend from few examples'),
    (-1.,'Leaps','Jumps to desired conclusion from ambiguous data'),
    (-1.,'Closed minded','Dismissive of plausible explanations without a better alternative'),
    (-1.,'Burden shifting','Asks others to disprove a non-obvious claim'),
    (-1.,'False choice','Presents an incomplete set of possibilities as complete'),
    (-1.,'Appeals','Appeals to popularity or authority or tradition or preference'),
    (-1.,'Is-ought','jumps from values to truth or reality to morality or argues from consequences'),
    (-1.,'Dumping','Attempts to overwhelm rather than convince, or promotes unsummarized canned content'),
    (-1.,'Vague conviction','Certain about something not even defined'),
    (-1.,'Word games','Supposes terms we define govern reality'),
    (-1.,'Unclear relevance','Misplaced, off-topic, incoherent, or spam'),
]
