...
rating_choices = [
    ...
    (1.,'Reasonable','An appropriate, intelligent, valid, or suitable response was given'),
    (1.,'Eloquent','An idea was elegantly and respectfully articulated'),
    (-1.,'Impolite','Ad hominem, poisoning the well, rude, petulent, flippant, or attempts to shame'),
    ...
    (-1.,'Anecdotal','Attempts to establish a trend from few examples, leans on witnesses for extraordinary events, or tries to establish guilt by association'),
    (-1.,'Closed minded','Dismissive without a better alternative, appeals to ignorance, assumes plausible explanation are false until proven true, cherry-picks which evidence is admissible'),
    ...
    (-1.,'Word games','Supposes terms we define govern reality, ontological arguments, defines something into existence, "proofs" that work for anything'),
    ...
    (-1.,'Vague conviction','Certain of something with no clear definition, conflates naming with explaining'),
    (-1.,'Dumping','Attempts to overwhelm rather than convince, asks opponent to digest unsummarized canned content, Gish Gallop, unnecessarily strong adjectives, excessive use of formatting or CAPS'),
